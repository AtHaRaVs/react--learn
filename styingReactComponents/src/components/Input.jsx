...
// here above we didn't left and space since space means children &:hover means hover on the element and not on its children
...
export default function CustomInput({ label, invalid, ...props }) {
  ...
  return (
    <p>
      <label className={labelClases} $invalid={invalid}>
        {label}
      </label>
      <input className={inputClases} $invalid={invalid} {...props} />
    </p>
  );
}
